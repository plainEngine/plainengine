...
function start()
	...
	putborder("upborder",		0,		10);
	putborder("downborder",		0,		-10);
	putborder("rightborder",	13,	0);
	putborder("leftborder",		-13,	0);
...
function MPHandlerOfMessage_keyDown(args)
